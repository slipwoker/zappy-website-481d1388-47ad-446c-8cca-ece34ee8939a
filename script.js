    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "תומר Barber shop משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('http://localhost:5001/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '481d1388-47ad-446c-8cca-ece34ee8939a',
                    name: data.name || '',
                    email: data.email || '',
